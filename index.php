            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row d-flex mb-2 d-none" id="filterArea">
                        ...
                        <div class="col">
                            <button class="btn-sm btn btn-success mt-4" id="filterBtn" type="button">Filter Now</button>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="mini-stat">
                                        ...
                                        <div class="mini-stat-info">
                                            ...
                                            <?php 
                                                     if ($allAmount=$con->query("SELECT SUM(paid) as totalPaid FROM customers")) {
                                                         while ($rows=$allAmount->fetch_array()) {
                                    ...
                                    <div class="card-body">
                                        <div class="mini-stat">
                                            ...
                                            <div class="mini-stat-info">
                                                ...
                                                <?php 
                                                     if ($allExpAmount=$con->query("SELECT SUM(amount) as ExpAmount FROM expense")) {
                                    ...
                                    <div class="card-body">
                                        <div class="mini-stat">
                                            ...
                                            <div class="mini-stat-info">
                                                ...
                                                <?php 
                                                         if ($allAmount=$con->query("SELECT SUM(amount) as withdrawAmount FROM withdraw")) {
                                                             while ($rows=$allAmount->fetch_array()) {
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Latest Admited Customer</h4>
...
<td><a href="profile.php?id=<?php echo $rows['id']; ?>"><?php echo $rows["customer_name"]; ?></a></td>
<td>
    <?php 
...
<td><?php echo $rows["due"]; ?></td> -->
                       ...
                       <?php } ?>            
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Latest Invoice</h4>
    ...
    <script type="text/javascript">
        ...
        function filterGetRequest(){
            ...
            if (from_date.length==0) {
                ...
                toastr.error("To Date is require");
                    ...
                    var studentFilter="0";
                    $("#filterBtn").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>');
        ...
        function netProfit(){
            ...
            var customerPaid=Number($("#customerPaid").html());
            var customer_recharge=Number($("#customer_recharge").html());
            //get the sum value customer paid & recharge 
            var totalGetMoney=(Number(customerPaid)+Number(customer_recharge));
            //console.log(totalGetMoney);
            //total spend from 
            var totalSpend=(totalExpense+totalWithdraw);
                //$("#totalSpend").html(totalSpend);
            var netProfit=totalGetMoney-totalSpend;
