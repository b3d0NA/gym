...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  if ($invoice = $con->query("SELECT * FROM inv WHERE customer_id='$id' ")) {
        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_mb20">
            <div class="tm_invoice_left">
              <div class="tm_logo"><img src="../images/logo.jpg" alt="Logo"><br> </div>
            </div>
          ...
          <div class="tm_invoice_left">
              <p class="tm_mb2 tm_f16"><b class="tm_primary_color tm_text_uppercase">Fitness King GYM Center</b></p>
              <p>
                Duch bangla bank 3rd floor <br>Gouripur Bazar, Daudkandi, Cumilla <br>
                www.fkgouripur.com <br>
                hello@fkgouripur.com<br>
                01580-651309
              </p>
            </div>
            <div class="tm_invoice_right" style="width:69% !important">
              <div class="tm_grid_row tm_col_2  tm_col_2_sm tm_invoice_table tm_round_border">
                ...
                <div>
                  ...
                  <b class="tm_primary_color"><?php echo $fullname; ?></b>
                </div>
                <div>
                  <p class="tm_m0">Package Name</p>
               ...
               <?php
                ...
                <div>
                  <p class="tm_m0">Admit Date</p>
                  <b class="tm_primary_color">
                    <?php
                    //$id=$id;
                    if ($batch3 = $con->query("SELECT * FROM customers WHERE id='$id' ")) {
                      while ($rows4 = $batch3->fetch_array()) {
                        echo $pck = $rows4['date'];
                      }
                    }
                          ...
                          if ($batch55 = $con->query("SELECT * FROM package WHERE package_id='$package' ")) {
                            while ($rows55 = $batch55->fetch_array()) {
                              echo $pck2 = $rows55['package_name'];
                               //$package_price = $rows55['package_price'];
                            }
                          }
                ...
                <table>
                  <tbody>
                    <tr class="tm_border_top">
                      ...
                      <td class="tm_width_3 tm_danger_color tm_text_right tm_border_none tm_bold"><?php echo $due . '৳'; ?></td>
                    </tr>

                    <tr class="tm_border_top">
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f18 tm_white_color tm_accent_bg tm_radius_6_0_0_6">Total Paid </td>
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f18 tm_primary_color tm_text_right tm_white_color tm_accent_bg tm_radius_0_6_6_0"><?php echo $paid . '৳'; ?></td>
                    </tr>
                  </tbody>
                </table>
              </div>
