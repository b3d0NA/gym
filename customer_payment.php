                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive" id="tableStyle">
                             <table id="customerDataTable" class="table table-striped table-bordered  " cellspacing="0" width="100%">
                                ...
                                <?php 
                          $sql="SELECT * FROM customer_recharge   ";
...
<td>
    ...
    $getCstmrId= $rows["customer_id"]; 
     if ($allCom = $con -> query("SELECT id,customer_name FROM customers WHERE id='$getCstmrId'  ")){
           while ($rowss=$allCom->fetch_array()) {
              $customerName= $rowss['customer_name'];
            echo '<a href="profile.php?id='.$getCstmrId.'">'.$customerName.'</a>';
           }
        } 
    ?>
...
<td><?php echo $rows["recharge_until"]; ?></td>
