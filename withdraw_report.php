                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="d-none d-sm-block ms-2">
                            <h4 class="page-title">Withdraw Filter</h4>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
           <div class="row" id="searchRow">
                <div class="col-md-4 col-sm m-auto">
                    <div class="card">
                        <div class="card-header">Withdraw Filter</div>
                        <div class="card-body">
        ...
        <script type="text/javascript">
            ...
            $("#searchBtn").on('click',function(){
                ...
                if (fromDate.length==0) {
                  ...
                  var WithdrawFilter="0";
                    $.ajax({
                           url:'include/withdraw.php', 
                           type:'POST',
                           data:{WithdrawFilter:WithdrawFilter,fromDate:fromDate,toDate:toDate},
                           success:function(response){
                            
                            $("#FilterTable").removeClass('d-none');
                               $("#expense_date").html(response);
