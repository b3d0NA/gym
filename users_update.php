...
if (isset($_GET['id'])) {
	 ...
	 if ($allStudent=$con->query("SELECT * FROM users WHERE id='$id' ")) {
		while ($rows=$allStudent->fetch_array()) {
			 $id= $rows['id'];
			 $name= $rows['fullname'];
        ...
        <div class="container d-none" id="mainDiv">
            <div class="row">
                <div class="col-md-8 m-auto">
                    <div class="card">
                        <div class="card-header bg-info text-white">Update user</div>
                        <div class="card-body">
                           <form>
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-sm">
                                       <div class="form-group mb-2">
                                           ...
                                           <input type="text" id="username" class="form-control" value="<?php echo $usr_name; ?>">
                                        </div>
                                   </div>
                               </div>
                               <div class="row">
                                   ...
                                   <div class="col-sm">
                                       <div class="form-group mb-2">
                                           ...
                                           <input type="text" id="password" class="form-control" value="<?php echo $usr_password; ?>" />
                                        </div>
                                   </div>
                                   <div class="col-sm">
                                       <div class="form-group mb-2">
        ...
        <script type="text/javascript">
        	$(document).ready(function(){
        		 ...
        		 $("#updateBtn").click(function(){
                    ...
                    udpateUserData(updateId,name,email,username,password);
        		 });
        		 function udpateUserData(updateId,name,email,username,password){
                     if (name.length==0) {
                        toastr.error("Name is require");
                         ...
                         var UpdateUserData="0";
                        $.ajax({
                     url:'include/users.php',
                     type:'POST',
                     data:{UpdateUserData:UpdateUserData,name:name,email:email,username:username,password:password,id:updateId},
