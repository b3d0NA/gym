                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-gruop mb-2">
                                ...
                                <!-- <input type="text" name="" id="customerId" placeholder="Enter Customer Id" class="form-control"> -->
                                <select name="" id="customerId" class="form-select" style="width:100%; height:25px;">
                                   <option value="">Select</option>
                                    <?php 
                                    if ($allCstmr=$con->query("SELECT * FROM customers")) {
                                        while($rows=$allCstmr->fetch_array()){
                                            echo '<option value=" '.$rows['id'].' ">'.$rows['customer_name'].' ('.$rows['mobile'].')</option>';
                                        }
                                    }
                    ...
                    <form id="addMainModal" class="d-none">
                        <div class="row d-flex">
                            <div class="form-group mb-2">
                                ...
                                <input id="addMoney" type="text" class="form-control" placeholder="Enter Your Amount" required>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        $(document).ready(function(){
            ...
            $("#searchBtn").on('click',function(){
                ...
                if (customerId.length==0) {
                    toastr.error("Customer Name require");
                }else{
                  var customerInvoice="0";
                    $.ajax({
                           url:'include/customer_invoice.php', 
                           type:'POST',
                           data:{customerInvoice:customerInvoice,id:customerId},
