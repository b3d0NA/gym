                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="d-none d-sm-block ms-2">
                            <h4 class="page-title">Expired Customer</h4>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
           <div class="row">
               <div class="col-md-12 ">
                ...
                <div class="card d-none" id="mainDiv">
                    <div class="card-body">
                    	 <a href="add_customer.php" class="btn-sm btn btn-success mb-2"><i class="mdi mdi-account-plus"></i>
                                        Add New Customer</a>
...
<!-- end main content-->
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                 ...
                 getExpireCustomerData()

                function getExpireCustomerData() {
                    var getExpireCustomerData="0";
                   $.ajax({
                        url:'include/customers.php',
                        type:'POST',
                        data:{getExpireCustomerData:getExpireCustomerData},
                        success:function(response){
                        	console.log(response);
                            $("#customer_table").html(response);
                             $("#loaderDiv").addClass('d-none'); 
                    		$("#mainDiv").removeClass('d-none');
                    		$("#customerDataTable").dataTable(deleteProcess());
                        }
                   });
                }
                  //delete  Script
