            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="d-none d-sm-block ms-2">
                        <h4 class="page-title">Customer's Package</h4>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive" id="tableStyle">
                                        <table id="packageDataTable" class="table table-striped table-bordered  " cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th class="th-sm">ID</th>
                                                    <th class="th-sm">Package Name</th>
                                                    <th class="th-sm">Price</th>
                                                    <th class="th-sm">Total Customer</th>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                                ...
                                <form id="mainModal" class="d-none">
                                    <div class="row d-flex">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <input id="updatePackagePrice" class="form-control">
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button id="updatePackageBtn" type="button" class="btn btn-primary">Update Now</button>
                            </div>
                        </div><!-- /.modal-content -->
                    </div><!-- /.modal-dialog -->
                </div><!-- /.modal -->
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body ">
                                ...
                                <form id="addMainModal" class="d-none">
                                    <div class="row d-flex">
                                        ...
                                        <div class="form-group mb-2">
                                            <label for="">Package Price</label>
                                            <input id="addPackagePrice" class="form-control" placeholder="Enter Your Package Price">
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button id="addPackageConfirmBtn" type="button" class="btn-sm btn btn-success"><i class="mdi mdi-account-plus"></i>&nbsp;Add Now</button>
                            </div>
                        </div><!-- /.modal-content -->
                    </div><!-- /.modal-dialog -->
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function allPackage() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $("#package_table").html(response);
                        $("#loaderDiv").addClass('d-none');
                        $("#packageDataTable").dataTable(deleteProcess(), editProcess());
                    }
                });
            }
            //delete  Script
            ...
            const getPackageDetails = (editId) => {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#updatePackagePrice").val(jsonData.package_price)
            ...
            $("#updatePackageBtn").click(function() {
                ...
                updatePackage(updateId,updatePackageName,updatePackagePrice);
            });

            const updatePackage = (updateId,updatePackageName,updatePackagePrice) => {
            ...
            $("#addPackageConfirmBtn").click(function() {
                var addPackageName = $("#addPackageName").val()
                var addPackagePrice = $("#addPackagePrice").val()
                addPackageData(addPackageName, addPackagePrice);
            });

            function addPackageData(addPackageName, addPackagePrice) {
