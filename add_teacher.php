                    ...
                    <form id="mainModal" class="d-none">
                        <div class="row d-flex">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input id="updateTeacherEmail" type="email" class="form-control" placeholder="Enter Your Email">
                            </div>
                            <div class="form-group mb-2">
                                <label for="">Address</label>
                                <textarea id="updateTeacherAddress" type="text" class="form-control" placeholder="Enter Address"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    ...
                    <form id="addMainModal" class="d-none">
                        ...
                        <div class="form-group mb-2">
                                <label for="">Teacher Name</label>
                                <input id="addTeacherName" type="text" class="form-control" placeholder="Enter Teacher Name">
                            </div>
                            <div class="form-group mb-2">
                                <label for="">Email</label>
                                <input id="addTeacherEmail" type="email" class="form-control" placeholder="Enter Your Email">
                            </div>
                            <div class="form-group mb-2">
                                <label for="">Address</label>
                                <textarea id="addTeacherAddress" type="text" class="form-control" placeholder="Enter Address"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
...
<!-- end main content-->
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    setTimeout(()=>{
                        ...
                        $("#updateTeacherName").val(jsonData.fullname);
                        $("#updateTeacherEmail").val(jsonData.email);
                        $("#updateTeacherAddress").val(jsonData.address);
                }
            });
        }
        $("#updateTeacherBtn").click(function() {
            ...
            var updateTeacherEmail = $("#updateTeacherEmail").val();
            var updateTeacherAddress = $("#updateTeacherAddress").val();
            updateTeacher(updateId,updateTeacherName,updateTeacherEmail,updateTeacherAddress);
        });

        const updateTeacher = (updateId,updateTeacherName,updateTeacherEmail,updateTeacherAddress) => {
            if (updateTeacherName.length == 0) {
                toastr.error("Teacher Name is require");
            }else if(updateTeacherEmail.length==0){
                 toastr.error("Email is require");
            }else if(updateTeacherAddress.length==0){
               ...
               $.ajax({
                     url:'include/teacher.php',
                     type:'POST',
                     data:{updateTeacherData:updateTeacherData,id:updateId,name:updateTeacherName,email:updateTeacherEmail,address:updateTeacherAddress},
                     success:function(response){
                        if (response==1) {
        ...
        $("#addTeacherConfirmBtn").click(function() {
            ...
            var addTeacherEmail = $("#addTeacherEmail").val();
            var addTeacherAddress = $("#addTeacherAddress").val();
            addTeacher(addTeacherName,addTeacherEmail,addTeacherAddress);
        });

        function addTeacher(addTeacherName,addTeacherEmail,addTeacherAddress) {
            if (addTeacherName.length == 0) {
                toastr.error("Teacher  Name is require");
            }else if(addTeacherEmail.length==0){
                toastr.error("Email is require");
            }else if(addTeacherAddress.length==0){
                toastr.error("Address is require");
            }
            else{
               ...
               $.ajax({
                     url:'include/teacher.php',
                     type:'POST',
                     data:{addTeacherData:addTeacherData,name:addTeacherName,email:addTeacherEmail,address:addTeacherAddress},
                     success:function(response){
                        if (response==1) {
