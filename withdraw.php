    ...
    <script type="text/javascript">
        ...
        //delete  Script
            ...
            $("#addWithdrawConfirmBtn").click(function(){
                ...
                addWithdrawData(title,description,exp_amount,exp_date);
            });
            ...
            function addWithdrawData(title,description,exp_amount,exp_date){
                if (title.length==0) {
                    toastr.error("Title is require");
                }else if (description.length==0){
                     toastr.error("Description is require");
                     ...
                     url:'include/withdraw.php',
                     type:'POST',
                     data:{addWithdrawData:addWithdrawData,title:title,description:description,exp_amount:exp_amount,exp_date:exp_date,},
                     success:function(response){
                        if (response==1) {
